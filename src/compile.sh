...
if g++ -c -O3 -funroll-loops custom_gfx.cpp -lSDL -lSDL_image; then
...
if g++ -o gbe config.o hash.o mbc1.o mbc2.o mbc3.o mbc5.o mmu.o z80.o gamepad.o filter.o gpu.o apu.o hotkeys.o opengl.o custom_gfx.o source.o -lSDL -lGL -lSDL_image; then
